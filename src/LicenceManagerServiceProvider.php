...
class LicenceManagerServiceProvider extends BasePackageServiceProvider
{
    protected $defer = true;
    /**
     * @var
     */
    protected $packageCode = 'corals-licence-manager';
    ...
    {
        Modules::addModulesPackages('corals/licence-manager');
    }
}
